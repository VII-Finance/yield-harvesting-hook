...
contract ERC4626VaultWrapperFactoryTest is Test {
    ...
    function setUp() public {
        factory = new ERC4626VaultWrapperFactory(harvester);
    }
    ...
    function test_createVaultWrapper() public {
        ...
        vm.expectEmit();
        emit ERC4626VaultWrapperFactory.VaultWrapperCreated(vaultAddress, expectedWrapperAddress);
        ...
        assertEq(wrapper.yieldHarvestingHook(), harvester);
        ...
        assertEq(address(wrapper.asset()), vaultAddress);
    }
}
